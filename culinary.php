...
if (!isset($_SESSION['email'])) {
 ...
 $email=$_SESSION['email'];
    ...
    $sql="SELECT * FROM resources WHERE category='culinary'"; 
        ...
        <div class="header-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="culinary.php"class="active">Culinary Resources</a></li>
...
<div class="container"> 
    ...
    <p>Downloadable guides, tips, and cooking tutorials.</p> 
